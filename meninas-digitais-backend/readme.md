...
1.  **Clone o repositório:**
    ```bash
    git clone https://github.com/Gnordh1/Certificadora-3/meninas-digitais-backend.git
    ```

2.  **Acesse a pasta do projeto:**
    ```bash
    cd meninas-digitais-backend
    ```
...
4.  **Configure as variáveis de ambiente:**
    - O arquivo `.env` é compartilhado para facilitar o desenvolvimento.
...
```
/meninas-digitais-backend
|-- /config
|   |-- database.js       # Configuração da conexão com o MongoDB
|-- /controllers
|   |-- authController.js   # Lógica para autenticação e registro
|   |-- eventController.js  # Lógica para o CRUD de eventos e inscrições
|   |-- userController.js   # Lógica para funcionalidades do usuário
|-- /middleware
|   |-- authMiddleware.js   # Middlewares de proteção e verificação de perfil
|-- /models
|   |-- Event.js            # Schema do Mongoose para Eventos
|   |-- User.js             # Schema do Mongoose para Usuários
|-- /routes
|   |-- authRoutes.js       # Definição das rotas de autenticação
|   |-- eventRoutes.js      # Definição das rotas de eventos
|   |-- userRoutes.js       # Definição das rotas de usuário
